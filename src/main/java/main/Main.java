...
public class Main
{
    ...
    private static final class DataSource
    {
        ...
        private DataSource() throws Exception
        {
            ...
            config.setJdbcUrl(System.getenv().containsKey("DATABASE_URL") ? String.join("", "jdbc:postgresql://", dbUri.getHost(), ":", String.valueOf(dbUri.getPort()), dbUri.getPath()) : "jdbc:mysql://sql109.epizy.com:3306/epiz_26248033_springboot");
            config.setUsername(System.getenv().containsKey("DATABASE_URL") ? dbUri.getUserInfo().split(":")[0] : "epiz_26248033");
            config.setPassword(System.getenv().containsKey("DATABASE_URL") ? dbUri.getUserInfo().split(":")[1] : "zG4SH4H8CD");
