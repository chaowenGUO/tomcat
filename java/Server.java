...
public class Server
{
	...
	final var connectionMono = Mono.from(io.r2dbc.spi.ConnectionFactories.get(String.join("", "jdbc:postgresql://", dbUri.getHost(), ":", String.valueOf(dbUri.getPort()), dbUri.getPath())).create());
